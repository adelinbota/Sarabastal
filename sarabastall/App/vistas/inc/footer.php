    ...
    <div class="container footer-bottom clearfix fixed-bottom">
      ...
      <div class="credits">
        <button type="button" 
          ...
          <img src="<?php echo RUTA_URL ?>/assets/img/icons8-accesibilidad-2-96.png" alt="" style="width: 50px; ">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo RUTA_URL ?>/assets/vendor/aos/aos.js"></script>
  <script src="<?php echo RUTA_URL ?>/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?php echo RUTA_URL ?>/assets/vendor/glightbox/js/glightbox.min.js"></script>
  <script src="<?php echo RUTA_URL ?>/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="<?php echo RUTA_URL ?>/assets/vendor/php-email-form/validate.js"></script>
