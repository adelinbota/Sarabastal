...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo RUTA_URL ?>/assets/img/favicon.png" rel="icon">
  <link href="<?php echo RUTA_URL ?>/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="<?php echo RUTA_URL ?>/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="<?php echo RUTA_URL ?>/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="<?php echo RUTA_URL ?>/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?php echo RUTA_URL ?>/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
...
<header id="header" class="d-flex align-items-center">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a href="index.html"><img src="<?php echo RUTA_URL ?>/assets/img/logo-fundacion-sarabastall.png" alt="" class="img-fluid" id="icono"></a>
      </div>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li id="li"><a class="nav-link scrollto" href="<?php echo RUTA_URL ?>/admin"><span>Gestión</span></a></li>
