...
<header id="header" class="d-flex align-items-center">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <a href="index.html"><img src="public/assets/img/logo-fundacion-sarabastall-removebg-preview.png" alt="" class="img-fluid" id="icono"></a>
      </div>

      <nav id="navbar" class="navbar">
        <ul>
          <li id="li"><a id="a" class="nav-link scrollto" href="#inicio">Inicio</a></li>
          <li id="li"><a id="a" class="nav-link scrollto" href="#microcreditos">Microcreditos</a></li>
          <li id="li"><a id="a" class="nav-link scrollto" href="#becas">Becas</a></li>
          <li id="li"><a id="a" class="nav-link scrollto " href="#cursos">Cursos</a></li>
          <li id="li" class="dropdown"><a href="#"><span>Gestión</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li id="li"><a id="a" href="<?php echo RUTA_URL?>/registro">Añadir Usuarios</a></li>
              <li id="li"><a id="a" href="#">Drop Down 2</a></li>
              <li id="li"><a id="a" href="#">Drop Down 3</a></li>
              <li id="li"><a id="a" href="#">Drop Down 4</a></li>
            </ul>
          </li>
