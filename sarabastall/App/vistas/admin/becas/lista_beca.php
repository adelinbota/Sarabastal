        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <!-- <tbody>
                    ...
                    <tr>
                        <td><?php //echo $beca->nombre_beca ?></td>
                        <td><?php //echo $beca->importe ?></td>
                        <td><?php //echo $beca->Obs ?></td>
                        <td><?php //echo $beca->fechaInicio ?></td>
                        <td><?php //echo $beca->fechaFin ?></td>
                        <td><?php //echo $beca->nombre_madrina ?></td>
                        <td><?php //echo $beca->fechaAbonoMadrina ?></td>
                        <td><?php //echo $beca->nombre_alumno ?></td> 
                        <td><?php //echo $beca->fechaAlumno ?></td>    
                        <td><?php //echo $beca->notaMedia ?></td>

                        <td><a href="<?php //echo RUTA_URL ?>/beca/editarbeca/<?php //echo $beca->idBeca ?>"><button type="button" class="btn btn-primary btn-square-md" style="margin-right:-20px"><i class="bi bi-pencil-square"></i></button></a></td>
                        <td><a href="<?php //echo RUTA_URL ?>/beca/borrarbeca/<?php //echo $beca->idBeca ?>"><button type="button" onclick="confirmar(event)" class="btn btn-primary btn-square-md"  style="margin-left:-20px" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-x-lg"></i></button></a></td>
                    </tr>
                    <?php //endforeach ?>
                </tbody> -->
            </table>
