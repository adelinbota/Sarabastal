...
<div >  
    ...
    <div class="card bg-light mt-5 w-75 card-center m-auto" >
        <h2 class="card-header"> Ver Cursos</h2>
            ...
            <table class="table table-hover">
                ...
                <!-- <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php //echo $curso->importe ?> €</td>

                        <td><a href="<?php //echo RUTA_URL ?>/curso/editarCurso/<?php //echo $curso->idCurso ?>"><button type="button" class="btn btn-primary btn-square-md" style="margin-right:-200px"><i class="bi bi-pencil-square"></i></button></a></td>
                        <td><a href="<?php //echo RUTA_URL ?>/curso/eliminarCurso/<?php //echo $curso->idCurso ?>"><button type="button" class="btn btn-primary btn-square-md"  style="margin-left:-110px" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-x-lg"></i></button></a></td>
                    </tr>
                    <?php //endforeach ?>
                </tbody> -->
            </table>
...
<div id="modal1" class="modal-container">
    ...
    <script type="text/javascript">// obtenemos el array de valores mediante la conversion a json del array de php
            let arrayJS = <?php echo json_encode($datos['cursos']);?>;
          // console.log(arrayJS);
