...
<section id="gestion">
    ...
    <div class="container">
        ...
        <div class="col-12">
                ...
                <a class="text-white" href="<?php echo RUTA_URL?>/curso"><button class="btn btn-dark mx-1 col-3">Ver</button></a>
        ...
        <div class="col-12">
            ...
            <a class="text-white" href="<?php echo RUTA_URL?>/microcredito/listaMicrocredito"><button class="btn btn-dark mx-1 col-3">Ver</button></a>
